...
let
  ...
  node-sources = pkgs.runCommand "node-sources" {} ''
  ...
  generatePackages = {
    ...
    let
      ...
      callPackage = callPackageWith {
        inherit fetchUrlWithHeaders namespaceTokens node-sources;
    ...
    in
    {
      inherit callPackage namespaceTokens pkgs node-build-tools node-sources;
